document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTimer() {
        ...
        if (timer.hour < 0) {
            ...
            document.querySelector('.bw-right__text').remove();
            document.querySelector('.bw-right__text').innerHTML = '<div class="timer-wrapper_end">Акція закінчилась</div>';
